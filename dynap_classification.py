...
def test_time_tuning(model, inputs, optimizer, scaler, args, log_file, device):
    ...
    for j in range(args.tta_steps):
        with torch.cuda.amp.autocast():
            ...
            if args.num_prompts > 1 and args.onlinetpt:
...
def main_worker(gpu, args):
    ...
    for set_id in datasets:
        ...
        logname = prefix + "{}_s{}_{}ctx_{}_{}_nump{}_{}%augs_{}ctxinit{}.txt".format(args.log_date, args.seed, args.n_ctx, model_arch, set_id, args.num_prompts, args.selection_p, args.lr, args.ctx_init)
